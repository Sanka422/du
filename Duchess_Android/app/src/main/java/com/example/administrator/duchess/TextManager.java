...
public class TextManager {
    ...
    public TextManager()
    {
        ...
        texturenr = 0;
        // Text shader
        int vshadert = Shader.loadShader(GLES20.GL_VERTEX_SHADER, Shader.vs_Text);
        int fshadert = Shader.loadShader(GLES20.GL_FRAGMENT_SHADER, Shader.fs_Text);

        mProgram = GLES20.glCreateProgram();
        GLES20.glAttachShader(mProgram, vshadert);
        GLES20.glAttachShader(mProgram, fshadert); 		// add the fragment shader to program
